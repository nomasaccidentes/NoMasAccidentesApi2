...
namespace NoMasAccidentesApi.Repositories
{
    public class RegistroAccidenteRepository : IRegistroAccidenteRepository
    {
        ...
        public object getAccidentabilidad(int contratoId)
        {
            ...
            try
            {
                ...
                {
                    var query = "GET_ACCIDENTABILIDAD";
        ...
        public object registroByAsesoriaId(int asesoriaId)
        {
            dynamic result = null;
            ...
            try
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    var query = "SP_GET_REG_ACCIDENTE_BY_AS";
